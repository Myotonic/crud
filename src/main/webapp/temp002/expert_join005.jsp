	...
	<div class="member_form text-left">
		<form action="expert_join.crud" method="post" class="form">
			...
			<div class="row emailCheck1">
				...
				<div class="col-sm-2">
					<input type="button" value="인증하기" class="btn emailCheck3" />
				</div>
			</div>
			...
			<div class="member_extra text-center">
				<a href="master_join.jsp" class="form-control btn">고수로 회원가입하러 가기</a>
			</div>
		<script>
			$(function(){
		      ...
		      //현재비밀번호 표시
				...
				$("form").on("submit", function(){
					...
					//이메일 중복이라면   data-check
					if($(".r2 span").attr("data-check")=="false"){
						$(".r2").html("이메일을 확인해주세요");
						$("#email").focus();
						return false;
					}
