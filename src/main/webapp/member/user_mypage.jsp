	...
	<div class="">
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<a href="AccountSetting.crud" title="계정설정" class="btn">계정설정</a>
			</div>
		</div>
		<hr/>
		<div class="">
			<div class=""><strong>클래스</strong></div>
			<div class=""><a href="${pageContext.request.contextPath}/myPageMarket.crud">구매 내역</a></div>
			<div class=""><a href="${pageContext.request.contextPath}/inquiryView.crud">문의 내역</a></div>
		</div>
		<hr/>
		<div class="last">
		...
		<div class="member_extra">
			<a href="MemberValue.crud" title="전환" class="btn form-control">고수 전환</a>
		</div>
	</div>
</div>
